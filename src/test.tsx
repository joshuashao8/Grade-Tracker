      ...
      <div className="w-full max-w-4xl flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-card text-card-foreground border border-border p-5 rounded-2xl flex flex-col gap-4 md:col-span-1 shadow-sm">
            ...
            <Button onClick={addCourse} className="w-full mt-2 font-bold">
              Record Entry
            </Button>
          </div>

          {/* Right Ledger Log View Display Panel */}
          <div className="bg-card text-card-foreground border border-border p-5 rounded-2xl flex flex-col gap-4 md:col-span-2 shadow-xl">
